...
public class DiningTable {
  ...
  public void takeForks(int philosopherId) throws InterruptedException {
    ...
    try {
      ...
      System.out.println(STR."Философ \{philosopherId} взял левую вилку.");
      forkLocks[rightForkIndex].lock();
      try {
        forks[rightForkIndex].pickUp();
        System.out.println(STR."Философ \{philosopherId} взял правую вилку.");
      } finally {
  ...
  public void releaseForks(int philosopherId) {
    ...
    System.out.println(STR."Философ \{philosopherId} положил левую вилку.");
    forks[rightForkIndex].putDown();
    System.out.println(STR."Философ \{philosopherId} положил правую вилку.");
